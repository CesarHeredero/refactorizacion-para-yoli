...
$subject = "ANUNCIARSE EN CINES: BEJAR, SALAMANCA, CASTILLA Y LEON / publicidadcines.com";

$message = '<div style="color:#C9415A; font-weight:bold;">ANUNCIARSE EN CINES: BEJAR, SALAMANCA, CASTILLA Y LEON / publicidadcines.com</div>  <br /><hr />';
