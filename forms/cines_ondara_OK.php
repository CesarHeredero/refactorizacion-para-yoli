...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($nombreErr) && empty($emailErr)){
		...
		$subject = "ANUNCIARSE EN CINES: ONDARA, ALICANTE, VALENCIA / publicidadcines.com";
		
		$message = '<div style="color:#C9415A; font-weight:bold;">ANUNCIARSE EN CINES: ONDARA, ALICANTE, VALENCIA / publicidadcines.com</div>  <br /><hr />';
