...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($nombreErr) && empty($emailErr)){
		...
		$subject = "ANUNCIARSE EN CINES: SEO DE URGEL, LERIDA, CATALUÑA / publicidadcines.com";
		
		$message = '<div style="color:#C9415A; font-weight:bold;">ANUNCIARSE EN CINES: SEO DE URGEL, LERIDA, CATALUÑA / publicidadcines.com</div>  <br /><hr />';
