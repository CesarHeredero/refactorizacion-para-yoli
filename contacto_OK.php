...
$to = "riosanchoyolanda@gmail.com";
//$to = "agcarlosandres@gmail.com";
//$from = "contacto@publicidadcines.com";
$from = "riosanchoyolanda@gmail.com";
...
$headers .= "From:riosanchoyolanda@gmail.com\r\n";
...
if($_SESSION['tmptxt']==$_POST["tmptxt"]);
  ...
  if ($success) {
    ...
    mail("riosanchoyolanda@gmail.com", $subject, $message, $headers);
    mail("riosanchoyolanda@gmail.com", $subject, $message, $headers);
