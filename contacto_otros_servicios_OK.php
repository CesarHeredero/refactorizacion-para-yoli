...
$subject = "Formulario de CONTACTO Otros servicios de publicidadcines.com";

$message = '<div style="color:#C9415A; font-weight:bold;">Formulario de CONTACTO Otros servicios de publicidadcines.com</div>  <br /><hr />';
...
$message .= 'Deseo información sobre: ' . utf8_decode ($_POST['info']).'<br />';
